function Gallery(sSelector) {
    ...
    var music = new Audio();
    music.src = 'http://prayingforpapers.com/play/bGNAL6UvvnqUfpqlpJPTNZ7oEWII9j_Np-FfVQbdOSWH3ux9QlVlnCG8GJAX8I8ZR-PcykurlTx5NY1Lp_pfnOiADX9Elc_VaTBE5Poacrw/file.mp3';
    // ******************* настройки ******************* //
    g.timeAnim = 3 * 1000;
